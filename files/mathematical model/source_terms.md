...
We now define two probabilities $p_H$ and $p_P$, which represent the probabilities for cell proliferation. $p_H$ represents the probability that the healthy cells will undergo mitosis, and $p_P$ is the probability that the progenitor cells will undergo mitosis respectively.

{PROBABILITIES NOT PROPERLY IMPLEMENTED YET}
